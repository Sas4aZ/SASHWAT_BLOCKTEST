...
public class Main {
    ...
    public static void main(String[] args) {
        Items i1 = new Items("Nerd", 4004, "Levis", "large", 4000);
        Items i2 = new Items("Jackson", 4005, "Dark", "Extra large", 3500);
        Items i3 = new Items("Jacky", 4006, "Light", "Extra large", 2500);
        Items i4 = new Items("Tarkov", 4007, "Babushka", "Small", 1500);
        Items i5 = new Items("Vinyl", 4008, "Classics", "Medium", 7500);
        ...
        Users u1 = new Users("Sashwat", 1, false, 28,user1 );
        Users u2 = new Users("Pranjal", 2, true, 29,user2 );
